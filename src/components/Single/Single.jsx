    ...
    <>
      <Container>
        <Box sx={{ marginTop: "170px" }}>
          <Typography
            sx={{ color: "#787993", fontWeight: "700", fontSize: "14px" }}
          >
      ...
      <Container>
              ...
              productData.map((product, i) => (
                ...
                >
                  ...
                  <CardContent>
                    ...
                    >
                      <Typography>{translation[lang].sing_arc}</Typography>
                      <Typography>{translation[lang].sing_data}</Typography>
                    </Box>
                    <Typography
                      sx={{
                        fontWeight: "bold",
        ...
        >
          <Typography
            sx={{ color: "#4E72CA", fontSize: "20px", fontWeight: "800" }}
          >
            {translation[lang].sing_foter}
          </Typography>
          <Typography
            sx={{ color: "#9B9B9B", fontSize: "20px", fontWeight: "800" }}
          >
